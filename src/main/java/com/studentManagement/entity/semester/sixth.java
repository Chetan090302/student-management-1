...
public class sixth {
    ...
    @ManyToOne
    @JoinColumn(name = "student-id5",nullable = false,insertable = false, updatable = false)
    private Student student5;

    public sixth() {
    }

    public sixth(String studentId, String subjectId, String internals, String externals, String regulation, String attendance) {
