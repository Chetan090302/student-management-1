...
public class second {
   ...
   @ManyToOne
   @JoinColumn(name = "student-id1",nullable = false, insertable = false, updatable = false)
   private Student student1;

    public second() {
    }

    public second(String studentId, String subjectId, String internals, String externals, String regulation, String attendance) {
