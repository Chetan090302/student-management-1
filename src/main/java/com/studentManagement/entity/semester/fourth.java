...
public class fourth {
    ...
    @ManyToOne
    @JoinColumn(name = "student-id3",nullable = false, insertable = false, updatable = false)
    private Student student3;

    public fourth() {
    }

    public fourth(String studentId, String subjectId, String internals, String externals, String regulation, String attendance) {
