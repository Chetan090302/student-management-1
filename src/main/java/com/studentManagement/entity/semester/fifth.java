...
public class fifth {
    ...
    @ManyToOne
    @JoinColumn(name = "student-id4",nullable = false,insertable = false, updatable = false)
    private Student student4;

    public fifth() {
    }

    public fifth(String studentId, String subjectId, String internals, String externals, String regulation, String attendance) {
