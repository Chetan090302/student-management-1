...
public class eighth {
    ...
    @ManyToOne
    @JoinColumn(name = "student-id7",nullable = false,insertable = false, updatable = false)
    private Student student7;

    public eighth() {
    }

    public eighth(String studentId, String subjectId, String internals, String externals, String regulation, String attendance) {
